        ...
        if(item.getFieldName().equals("callback")) {
            ...
            if(item.getSize() > 0) {
                ...
                if(cnt == 0) {
                    ...
                    //파일 기본경로 _ 상세경로
                    String filePath = Constants.FILE_BASIS_PATH + File.separator;
                    
                    //String path = Constants.FILE_BASIS_PATH; // 이미지가 저장될 주소
                    ...
                    return3 += "&sFileURL="+Constants.FILE_BASIS_URL+realFileNm;
                }
            }else {
