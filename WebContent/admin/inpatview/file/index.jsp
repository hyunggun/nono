...
<head>
    ...
    function evClickDelete(idx) {
        ...
        jQuery("#page_no").val(jQuery("#mainDataTable").DataTable().page.info().page);
	      ...
	      $.ajax({
            url : "${inpatviewPath}/file/json/deleteFile.jsp",
            type : "POST",
            cache : false,
            dataType : "json",
            data : data,
            success: function( result ) {
            	if(result.resultData.resultCode) {
              	alert("삭제하였습니다.");
              	location.href="${inpatviewPath}/file/index.jsp?page_no="+result.resultData.page_no;
              } else {
              	alert("삭제에 실패하였습니다.");
              }
            },
    ...
    function evClickSetting(idx) {
  	  location.href = "${inpatviewPath}/file/room/index.jsp?file_id="+idx;
    }
    </script>
</head>
      ...
      <div class="be-content">
        ...
        <div class="main-content container-fluid">
          <div class="cf-search-area">
	          <div class="row">
	            <div class="col-sm-12">
                <form id="cfMainForm" name="mainForm" method="POST" action="${inpatviewPath}/file/uploadProc.jsp" enctype="multipart/form-data">
