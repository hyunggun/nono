...
//     treatMap = treatBiz.selectEmrCountPage(paramMap);
} catch(Exception ex) {
    ex.printStackTrace();
}
%>
<c:set var="userMap" value="<%=userMap%>" />
<c:set var="treatMap" value="<%=treatMap%>" />
<%-- <c:set var="patientMap" value="<%=patientMap%>" /> --%>
<c:set var="paramMap" value="<%=paramMap%>" />
<head>
<link href="${contextPath}/common/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
      <div class="be-content">
        <div class="main-content container-fluid">
        	<div class="row">
<c:if test="${sessionScope.SESSION_EMR_FG eq 'TRUE'}">
            <div class="col-sm-12">
              <div class="widget widget-tile">
                ...
                <div class="data-info col-xs-6">
                  ...
                  <div class="value">
                    ...
                    <span id="allDetectorCount" data-toggle="counter" data-start="0" data-end="10" class="number">${treatMap.treatCount}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-12">
              <div class="widget widget-tile">
                ...
                <div class="data-info col-xs-6">
                  ...
                  <div class="value">
                    <span class="indicator indicator-equal mdi mdi-chevron-right"></span>
                    <span id="allCompanyCount" data-toggle="counter" data-start="0" data-end="10" class="number">${treatMap.inpatientCount}</span>
                  </div>
                </div>
              </div>
            </div>
