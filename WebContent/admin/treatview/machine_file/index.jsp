    ...
    <script type="text/javascript">
      ...
      function evClickDelete(idx) {
          ...
          jQuery("#page_no").val(jQuery("#mainDataTable").DataTable().page.info().page);
  	      ...
  	      $.ajax({
              url : "${treatviewPath}/machine_file/json/deleteFile.jsp",
              type : "POST",
              cache : false,
              dataType : "json",
              data : data,
              success: function( result ) {
              	if(result.resultData.resultCode) {
                	alert("삭제하였습니다.");
                	location.href="${treatviewPath}/machine_file?page_no="+result.resultData.page_no;
                } else {
                	alert("삭제에 실패하였습니다.");
                }
              },
      ...
      function evClickSetting(idx) {
    	  location.href = "${treatviewPath}/machine_file/machine?file_id="+idx;
      }
    </script>
</head>
        	...
        	<div class="cf-search-area">
	          <div class="row">
                ...
                <form id="cfMainForm" name="mainForm" method="POST" action="uploadProc.jsp" enctype="multipart/form-data">
                	...
                	<input type="hidden" name="file_position" value="T">
                  <table class="table" style="margin:0;">
                    <tbody>
                      <tr class="text-center">
                        ...
                        <td style="border:0;"> <input name="machineImage" type="file" accept="image/*" onchange="readURL(this)"/></td>
                        <td style="border:0;">
...
<c:forEach var="data" items="${fileList}" varStatus="status">
                      <tr class="text-center">
                        ...
                        <td>
                        	<button type="button" class="btn btn-primary" onclick="evClickSetting(${data.file_id})">연동</button>
